...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
You have to run the "Preprocessing_fasta.sh" or "Preprocessing_genbank.sh" to change the fasta file in a fastq file resembling raw illumina output. Then you run the "CISGUIDE_primary2.sh"
